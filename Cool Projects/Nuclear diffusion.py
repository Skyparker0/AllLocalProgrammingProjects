# -*- coding: utf-8 -*-
"""
Created on Sat Apr 23 13:10:46 2022
...
class Node:
    ...
    def update(self):
        for other in self.neighbors:
            other.give_value(self.value/(len(self.neighbors)+1))
        self.give_value(self.value/(len(self.neighbors)+1))
        self.value = 0
