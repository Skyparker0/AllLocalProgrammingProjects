# -*- coding: utf-8 -*-
"""
Created on Sat Jul 31 08:47:05 2021
...
path = "C:/Users/batte/OneDrive/_Parker/Python/ProjectEuler/non-code-files/p083_matrix.txt"
...
grid = Grid(trueMatrix)

A = AStar(grid, (0,0), (79,79))

print(4445 + A.solve()[-1].get_walkCost())